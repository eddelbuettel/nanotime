...
Add extra <code>const_cast</code> as one CRAN machine with more ancient
setup whines otherwise and is obviously less C++20 ready than it thinks

</li>
<li>

<code>tools/configure</code> also checks where this is being built and
‘as needed’ downgrades the compilation to C++17
